...
public class News extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // final TextView txtview = (TextView)v.findViewById(R.id.tV1);
        webView= (WebView) v.findViewById(R.id.newswebview);
        Pbar= (ProgressBar) v.findViewById(R.id.pBnews);
        webView.loadUrl("http://www.exoncloud.com/JavaInstituteNewsSlider.jsp");
